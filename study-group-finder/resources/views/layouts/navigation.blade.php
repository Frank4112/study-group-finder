<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Study Requests -->
                    <x-nav-link :href="route('study-requests.index')" :active="request()->routeIs('study-requests.*')">
                        Study Requests
                    </x-nav-link>

                    <!-- Project Requests -->
                    <x-nav-link :href="route('project-requests.index')" :active="request()->routeIs('project-requests.*')">
                        Project Requests
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('study-requests.index')" :active="request()->routeIs('study-requests.*')">
                Study Requests
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('project-requests.index')" :active="request()->routeIs('project-requests.*')">
                Project Requests
            </x-responsive-nav-link>
